...
- Stack: TypeScript, JavaScript, Python, Java, Go, SQL, React, Next.js, Node.js, FastAPI, Prisma, tRPC, PostgreSQL, Supabase, SQLite, Docker, AWS, MCP, LSP, CI/CD.

## Target Archetypes (6 core + 1 analog)

| Archetype | Signal in JD | Fit |
|---|---|---|
| New Grad / Early-Career SWE | "new grad", "2026-2027 grad", "entry level", "associate" | Primary |
...
| Backend / AI Engineer | Python, APIs, data workflows, LLM systems, cloud architecture | Primary |
| Applied AI Engineer | LLM workflows, retrieval, agents, evaluation, product integration | Primary |
| Product Engineer | Product judgment, full-stack delivery, customer workflows | Primary |
| Product / Platform Engineer | internal tools, DevEx, monorepo, shared infra | Primary |
| Forward-Deployed / Solutions Engineer | client-facing, fast delivery, prototype-to-prod | Primary (only if 0-2 YOE) |
...
- Dsci-proj: reproducible survival-analysis pipeline plus Next.js triage dashboard with CI and fixture-backed UI tests
