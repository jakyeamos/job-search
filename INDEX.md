...
| Inspect/sync authenticated marketplace tabs | `node marketplace.mjs doctor --source all` · `node marketplace.mjs sync --source all --write` |
| Auto-fill an application | `node apply/fill-{greenhouse,ashby,lever}.mjs <url> --resume <pdf>` |
| Check / preview / apply / rollback updates | `node update-system.mjs check\|preview [ref]\|apply\|rollback` |
