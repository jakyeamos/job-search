...
func (m appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case screens.PipelineUpdateStatusMsg:
		...
		if err != nil {
			...
			m.pipeline = m.pipeline.WithFlash("Status update failed: " + err.Error())
			return m, nil
		}
		m.reloadPipelineData()
		m.pipeline = m.pipeline.WithFlash("Status updated to " + msg.NewStatus)
		return m, nil
	...
	case screens.PipelineUpdateStatusAndNotesMsg:
		...
		m.reloadPipelineData()
		m.pipeline = m.pipeline.WithFlash("Status and reason updated to " + msg.NewStatus)
		return m, nil
